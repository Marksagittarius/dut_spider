let router
let url = "../static/router/actress.json"
...
request.onload = function() {
    if (request.status === 200) {
        ...
        for (let path of router.charts) {
            ...
            document.getElementById(path).innerHTML = `<object class="chart type="text/html" data="../static/charts/actress/${path}.html" width=100% height=100%></object>`
        }
    }
}
